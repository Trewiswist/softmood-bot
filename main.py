...
CATEGORIES = {
    ...
    "suits": {
        ...
        "items": [
            {
    "name": "Классический чёрный костюм оверсайз 🖤",
    "price": "820 ₴",
    "description": "Элегантный костюм-двойка, который сидит идеально! ✨\n\n💼 Жакет:\n• V-образный вырез\n• Плечики для красивой формы\n• Длинный рукав 60 см\n• Застёжка на пуговицы\n• Без подкладки — легко и комфортно\n\n👖 Брюки:\n• Высокая посадка\n• Молния + пуговица\n• Прямой крой\n\n📏 Размеры: 42-44 (S-M) и 46-48\n📏 Параметры модели 42-44: ОГ 88 / ОТ 66 / ОБ 88\n🖤 Цвет: классический чёрный\n🧵 Ткань: костюмка (плотная, держит форму)\n\nСупер-вариант для работы, собеседований и стильных выходов 🔥",
    "photo": "https://images.prom.ua/5471039199_w640_h640_zhenskij-chernyj-bryuchnojklassicheskijdelovoj.jpg"
},
            {
