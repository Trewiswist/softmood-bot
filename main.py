...
CATEGORIES = {
    ...
    "price": "1462 ₴",
    "description": "Характеристики, которые вас покорят:\n\n🧥 Материал: эко-кожа (мягкая, матовая, не трескается на морозе)\n☁️ Утеплитель: силикон 250 г/м² — тепло даже при -20°C\n📏 Длина по центру спинки: 88 см\n👉 Длина рукава: 62 см\n🔒 Фурнитура: качественная молния + декоративные кнопки\n🧣 Вшитый капюшон\n🎀 Низ на кулиске со шнурком — можно затянуть\n\nРазмеры: S (42), M (44), L (46)\nЦвет: нежный бежевый\nСезон: осень / зима\nСостояние: абсолютно новый\n\nСтильная, тёплая и практичная курточка на каждый день ❄️✨",
    "photo": "https://images.prom.ua/3934994526_w640_h640_zhenskaya-zimnij-puhovik.jpg"
},
            {
    "name": "Женская зимняя куртка оверсайз короткая 6260_4086 ❄️",
    "price": "1244 ₴",
    "description": "Тёплая • Стильная • Не продуваемая 🖤\n\n❄️ Характеристики:\n• Ткань: матовая плащевка Канада\n• Утеплитель: синтепон 250 г\n• Подкладка: из основной ткани\n• Капюшон: съёмный на кнопках\n• Застёжка: молния + планка на пуговицах\n• Карманы: 2 глубоких боковых\n• Регулировка низа: есть фиксаторы\n\n📏 Замеры:\n• Длина изделия ≈ 74–75 см\n• Длина рукава ≈ 62 см\n\nРазмеры в наличии:\n42–46 (ОГ ≈ 105–110 см)\n48–50 (ОГ до 120 см)\n\n🌈 Цвета в наличии:\nчерный • белый • шоколад • барби • графит • бордо • малина • красный • светло-серый\n\nКомфортно до -20°C ❄️🔥\nТвоя идеальная зимняя куртка 2025/26 🏙️",
    "photo": "https://images.prom.ua/6383632495_w640_h640_zhenskaya-zimnyaya-kurtka.jpg"
},
        ],
    },
}
